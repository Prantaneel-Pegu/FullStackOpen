...
app.post('/api/persons/', (req, res, next) => {
  getPersons()
    .then(persons => {
      const newPerson = { ...req.body, id: generateId() } // Generate an id as failsafe, normally mongodb will auto generate for us
...
app.put('/api/persons/:id', (req, res, next) => {
  getPersons()
    .then(persons => {
      const id = req.params.id
      const updatedContactToSend = req.body
...
app.delete('/api/persons/:id', (req, res, next) => {
  getPersons()
    .then(persons => {
      ...
      const personToDelete = personIds.indexOf(id)
